...
Coherence_Function_NON_Par = cat(4,GammaTop,GammaBot,GammaUnder);

name = ['Non_uniform_Parab_phi' num2str(round(phi/pi*180)) '_AX' num2str(AX) '_BY' num2str(BY) '_sigma' num2str(sigma2) '_fs' num2str(fs/1000000000) 'HHz.mat'];
save(name)